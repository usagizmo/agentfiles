...
| いつ                                         | どれ                                                                                                                                                                                                                                                                                                                                                    |
| -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 記録を読んで判定するとき（正規化・発火条件） | `references/wait-record.md`（人待ち）・`references/same-branch.md`（宣言の読み取り・帰属・代表）・`references/ready-record.md`（在庫の鮮度）・`references/body-digest.md`（本文と計画の突き合わせ）・`references/intent-record.md`（意図の確認）・`references/integration-record.md`（merge の枠）・`references/protocols.md`（休止と失敗の記録の書式） |
...
| 2   | **片付ける**                 | `progress` が `着地済み` / `取り下げ`、**かつ**（`capacity` が `あり` / `prunable` または セッションが残っている または 人待ちの記録が `waiting` または 渡しの記録が残っている または 周回の記録が残っている）                                                                                                                                                                                                                                                                                                                                                                                                | 成果を確認してから実体を消し、記録を閉じる（手順は `references/protocols.md`。**成果の確認を飛ばさない**）                                                                                                                                                                                                          |
